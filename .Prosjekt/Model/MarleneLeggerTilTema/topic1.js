function updateViewTopicPage() {
  ...
  <button onclick="changeTopicLast()">Forrige tema</button>
    <div id="colum0">
        ...
        <iframe width="809" height="455" src="${oppgaver[0].videoLink}" title="TINY HABITS by BJ Fogg | Core Message" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</iframe>
